function Weight()
	...
	CityGetRandomBuilding("CITY_OF_OFFICE",GL_BUILDING_CLASS_PUBLICBUILDING,GL_BUILDING_TYPE_TOWNHALL,-1,-1,FILTER_IGNORE,"CouncilBuilding")
	
	if HasProperty("CouncilBuilding","MeetingTasks") then
		if (GetProperty("CouncilBuilding","MeetingTasks") >= 3) then
			return 0
		end
	end	
