function Run()
	...
	GetLocatorByName("Building", "Propel", "StandPosition")
	if not f_MoveTo("","StandPosition") then
	    MsgQuick("","_HPFZ_ARTEFAKT_SOCKEN_FEHLER_+2")
		StopMeasure()
	end
	local	Alias
  ...
  if SimGetGender("") == 1 then
	...
	CarryObject("","",false)								
	RemoveItems("","Handwerksurkunde",1)
