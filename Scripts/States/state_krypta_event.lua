function Run()
	...
	if Selection==0 then
		state_krypta_event_NeedItems()
	elseif Selection==1 then
		state_krypta_event_OfferItems()
	end
...
function CleanUp()
	...
	if Selection==0 then
		state_krypta_event_NeedItemsCleanUp()
	elseif Selection==1 then
		state_krypta_event_OfferItemsCleanUp()
	end
...
function OfferItems()
	...
	local	Item = state_krypta_event_OfferItemsFindItem(random)
	if not Item then
		return
	end
